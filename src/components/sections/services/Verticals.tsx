          ...
          {c.items.map((it, i) => (
            <StaggerItem key={it.title}>
              <article className="group relative overflow-hidden rounded-[2rem] bg-white ring-1 ring-navy/8 transition-all duration-700 ease-out-expo hover:-translate-y-2 hover:shadow-[0_40px_90px_-40px_rgba(22,57,78,0.5)]">
                <VideoArt art={{ src: it.art, alt: it.title, video: it.artVideo, videoMp4: it.artVideoMp4, width: 1200, height: 750 }} className="aspect-[16/10] transition-transform duration-1000 ease-out-expo group-hover:scale-[1.02]" rounded="rounded-none" />
